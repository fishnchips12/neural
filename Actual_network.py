...
class network(object):
    def __init__(self):
        self.weights1 = np.random.randn(550,784)
        self.weights2 = np.random.randn(10,550)
        self.biases1 = np.random.randn(550,1)
